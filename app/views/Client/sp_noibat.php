                    ...
                    <article class="single_product">
                        <figure>
                            ...
                            <figcaption class="product_content">
                                ...
                                <h3 class="product_name"><a href="chitietsanpham.php">Pellentesque posuere hendrerit
                                        dui</a></h3>
                    ...
                    <article class="single_product">
                        <figure>
                            ...
                            <figcaption class="product_content">
                                ...
                                <h3 class="product_name"><a href="chitietsanpham.php">Auctor gravida enim pellentesque
                                        quam</a></h3>
                                <div class="add_to_cart">
                                    <a href="cart.html" title="add to cart">Add to cart</a>
                                </div>
                    ...
                    <article class="single_product">
                        <figure>
                            ...
                            <figcaption class="product_content">
                                ...
                                <h3 class="product_name"><a href="chitietsanpham.php">Kaoreet lobortis sagittis
                                        pellentesque</a></h3>
                                <div class="add_to_cart">
                                    <a href="cart.html" title="add to cart">Add to cart</a>
                                </div>
                    ...
                    <article class="single_product">
                        <figure>
                            ...
                            <figcaption class="product_content">
                                ...
                                <h3 class="product_name"><a href="chitietsanpham.php">Cras neque honcus consectetur
                                        magna</a></h3>
                                <div class="add_to_cart">
                                    <a href="cart.html" title="add to cart">Add to cart</a>
                                </div>
                    ...
                    <article class="single_product">
                        <figure>
                            ...
                            <figcaption class="product_content">
                                ...
                                <h3 class="product_name"><a href="chitietsanpham.php">Duis pulvinar obortis eleifend
                                        elementum</a></h3>
                                <div class="add_to_cart">
                                    <a href="cart.html" title="add to cart">Add to cart</a>
                                </div>
                    ...
                    <article class="single_product">
                        <figure>
                            ...
                            <figcaption class="product_content">
                                ...
                                <h3 class="product_name"><a href="chitietsanpham.php">Fusce ultricies dolor vitae
                    ...
                    <article class="single_product">
                        <figure>
                            ...
                            <figcaption class="product_content">
                                ...
                                <h3 class="product_name"><a href="chitietsanpham.php">Natus erro at congue massa
                                        commodo sit</a></h3>
                                <div class="add_to_cart">
                                    <a href="cart.html" title="add to cart">Add to cart</a>
                                </div>

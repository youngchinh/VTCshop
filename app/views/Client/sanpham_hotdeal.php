        ...
        <div class="row">
                        ...
                        <div class="widget_list">
                            ...
                            <div class="recent_product_container">
                                <article class="recent_product_list">
                                    <figure>
                                        <div class="product_thumb">
                                            <a href="product-details.html"><img src="../views/Client/assets/img/product/product1.jpg" alt=""></a>
                                        </div>
                                ...
                                <article class="recent_product_list">
                                    <figure>
                                        <div class="product_thumb">
                                            <a href="product-details.html"><img src="../views/Client/assets/img/product/product2.jpg" alt=""></a>
                                        </div>
                                        <div class="product_content">
                                ...
                                <article class="recent_product_list">
                                    <figure>
                                        <div class="product_thumb">
                                            <a href="product-details.html"><img src="../views/Client/assets/img/product/product24.jpg" alt=""></a>
                                        </div>
                                        <div class="product_content">
            ...
            <div class="col-lg-9 col-md-12">
                ...
                <div class="row shop_wrapper">
                    ...
                    <?php
                    foreach ($sp_hotdeal as $sp) {
                        extract($sp);
                        $imgpath = "../upload/sp_hotdeal/" . $img_sanpham;
                                    ...
                                    <figure>
                                        <div class="product_thumb">
                                            ...
                                            <div class="label_product">
                                                <span class="label_sale">selling</span>
                                            </div>

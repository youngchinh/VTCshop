<?php 
    ...
    function update_sanpham($id_sanpham ,$ten_sanpham, $img_sanpham ,$mota_sanpham, $mau_sanpham, $gia_ban_dau, $gia_khuyen_mai, $dung_luong, $so_luong, $trang_thai, $id_danhmuc) {
        ...
        if($img_sanpham!=""){
            ...
            $sql = "UPDATE `tb_sanpham` SET `ten_sanpham` = '$ten_sanpham', `img_sanpham` = '$$img_sanpham',  `mota_sanpham` = '$mota_sanpham', `mau_sanpham` = '$mau_sanpham', `gia_ban_dau` = '$gia_ban_dau', `gia_khuyen_mai` = '$gia_khuyen_mai', `dung_luong` = '$dung_luong', `so_luong` = '$so_luong', `trang_thai` = '$trang_thai', `id_danhmuc` = '$id_danhmuc' WHERE `tb_sanpham`.`id_sanpham` = $id_sanpham;";
        }else{
            $sql = "UPDATE `tb_sanpham` SET `ten_sanpham` = '$ten_sanpham', `mota_sanpham` = '$mota_sanpham', `mau_sanpham` = '$mau_sanpham', `gia_ban_dau` = '$gia_ban_dau', `gia_khuyen_mai` = '$gia_khuyen_mai', `dung_luong` = '$dung_luong', `so_luong` = '$so_luong', `trang_thai` = '$trang_thai', `id_danhmuc` = '$id_danhmuc' WHERE `tb_sanpham`.`id_sanpham` = $id_sanpham;";
